...
public class InputHandlerDirectNoPan extends InputHandlerGeneric {
	static final String TAG = "InputHandlerDirectNoPan";
	public static final String ID = "TOUCH_ZOOM_MODE_DRAG_NOPAN";

	public InputHandlerDirectNoPan(RemoteCanvasActivity activity, RemoteCanvas canvas,
	...
	public String getDescription() {
		return canvas.getResources().getString(R.string.input_method_direct_drag_nopan_description);
	}
